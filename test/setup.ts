...
process.env.MQTT_USERNAME = "homeassistant";
process.env.MQTT_PASSWORD = "secret";
process.env.MQTT_CLIENT_ID = "thermo-api-test";
process.env.MQTT_SENSOR_SOURCE = "zigbee";
process.env.MQTT_SENSOR_TOPIC = "zigbee2mqtt/0x7c3e82d71df90000";
process.env.MQTT_SENSOR_STALE_MS = "180000";
